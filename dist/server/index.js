globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/admin-client-DLOnXw8i.js","assets/site-shell-DZsTUML_.js","assets/layout-segment-context-BXH1r-2B.js"];
...
function getDraftSecret() {
	return "2d81097b-a12a-476b-ab59-2af83e3db29b";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "40b54bcf-d9da-4eef-a7d7-65e194336d2e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "40b54bcf-d9da-4eef-a7d7-65e194336d2e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "40b54bcf-d9da-4eef-a7d7-65e194336d2e",
		rootBoundaryId
	});
}
/**
...
var site_shell_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "6f014b4f0add", "default");
//#endregion
//#region app/page.tsx
var page_exports$7 = /* @__PURE__ */ __exportAll({ default: () => Home });
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(site_shell_default, { page: "home" });
}
...
var metadata$4 = {
	title: {
		default: "Сети96 — промывка систем отопления",
		template: "%s | Сети96"
	},
	description: "Химическая промывка котлов, теплообменников, ИТП и систем отопления в Екатеринбурге. Бесплатный выезд специалиста.",
	icons: { icon: "/favicon.svg" },
	openGraph: {
		title: "Сети96",
		description: "Профессиональная промывка систем отопления",
		type: "website"
	}
};
var metrika = `(function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};m[i].l=1*new Date();for(var j=0;j<document.scripts.length;j++){if(document.scripts[j].src===r){return;}}k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)})(window,document,'script','https://mc.yandex.ru/metrika/tag.js?id=111900032','ym');ym(111900032,'init',{ssr:true,webvisor:true,clickmap:true,referrer:document.referrer,url:location.href,accurateTrackBounce:true,trackLinks:true});`;
function Layout({ children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("html", {
		lang: "ru",
		children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("script", { dangerouslySetInnerHTML: { __html: metrika } }) }), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("body", { children: [children, /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("noscript", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("img", {
...
var $$wrap_Layout = /* @__PURE__ */ __vite_rsc_wrap_css__(Layout, "default");
...
var admin_client_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "32ca04999434", "default");
//#endregion
...
async function Admin() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(admin_client_default, {
		user: "Администратор",
		signout: "/"
	});
}
//#endregion
//#region app/chatgpt-auth.ts
...
//#endregion
//#region app/api/leads/route.ts
var route_exports = /* @__PURE__ */ __exportAll({
	GET: () => GET,
	POST: () => POST
});
var schema = `CREATE TABLE IF NOT EXISTS leads (id INTEGER PRIMARY KEY AUTOINCREMENT, created_at TEXT NOT NULL, name TEXT NOT NULL, phone TEXT NOT NULL, client_type TEXT NOT NULL, page TEXT, status TEXT NOT NULL DEFAULT 'новая', telegram_status TEXT NOT NULL DEFAULT 'не настроен', comment TEXT)`;
async function runtime() {
	const { env } = await import("cloudflare:workers");
	const e = env;
	await e.DB.prepare(schema).run();
	return e;
}
var clean = (v) => v.replace(/[<>&]/g, (c) => ({
	"<": "&lt;",
	">": "&gt;",
	"&": "&amp;"
})[c]);
async function POST(req) {
	...
	const e = await runtime(), created = (/* @__PURE__ */ new Date()).toISOString();
	...
	if (e.TELEGRAM_BOT_TOKEN && e.TELEGRAM_CHAT_ID) {
		const text = ["<b>Новая заявка с Сети96.рф</b>", ...[
			["Тип клиента", b.clientType],
			["Имя", b.name],
			["Телефон", b.phone],
			["Дата и время", new Date(created).toLocaleString("ru-RU", { timeZone: "Asia/Yekaterinburg" })],
			["Страница", b.page],
			["Источник", b.source],
			["Кампания", b.utm_campaign],
			["Объявление", b.utm_content],
			["Поисковый запрос", b.utm_term]
		].filter(([, v]) => v).map(([k, v]) => `<b>${k}:</b> ${clean(v)}`)].join("\n");
		try {
			const tg = await fetch(`https://api.telegram.org/bot${e.TELEGRAM_BOT_TOKEN}/sendMessage`, {
				method: "POST",
			...
			telegramStatus = tg.ok ? "доставлено" : `ошибка ${tg.status}`;
		} catch {
...
async function GET() {
	...
	const rows = await (await runtime()).DB.prepare("SELECT * FROM leads ORDER BY id DESC LIMIT 200").all();
	return Response.json(rows.results);
}
//#endregion
//#region app/dom/page.tsx
var page_exports$5 = /* @__PURE__ */ __exportAll({
	default: () => Page$4,
	metadata: () => metadata$3
});
var metadata$3 = { title: "Промывка отопления частного дома" };
function Page$4() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(site_shell_default, { page: "dom" });
}
//#endregion
//#region app/kontakty/page.tsx
var page_exports$4 = /* @__PURE__ */ __exportAll({
	default: () => Page$3,
	metadata: () => metadata$2
});
var metadata$2 = { title: "Контакты" };
function Page$3() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(site_shell_default, { page: "contacts" });
}
//#endregion
//#region app/materialy/page.tsx
var page_exports$3 = /* @__PURE__ */ __exportAll({
	default: () => Page$2,
	metadata: () => metadata$1
});
var metadata$1 = { title: "Полезные материалы" };
function Page$2() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(site_shell_default, { page: "blog" });
}
//#endregion
//#region app/organizaciyam/page.tsx
var page_exports$2 = /* @__PURE__ */ __exportAll({
	default: () => Page$1,
	metadata: () => metadata
});
var metadata = { title: "Промывка ИТП и систем отопления для организаций" };
function Page$1() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(site_shell_default, { page: "org" });
}
//#endregion
//#region app/politika/page.tsx
var page_exports$1 = /* @__PURE__ */ __exportAll({ default: () => Page });
function Page() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Политика конфиденциальности" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "При отправке формы пользователь добровольно передаёт имя, номер телефона и тип клиента для обратной связи по вопросу оказания услуг." }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Цель обработки" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Связаться с пользователем, уточнить задачу и организовать осмотр объекта. Данные не публикуются и не используются для иных целей без законного основания." }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Согласие" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Отправляя форму, пользователь подтверждает согласие на обработку указанных данных. Контакт оператора и юридические реквизиты будут опубликованы после их добавления владельцем сайта." })
		]
	});
}
//#endregion
//#region app/materialy/[slug]/page.tsx
var page_exports = /* @__PURE__ */ __exportAll({ default: () => Article });
function Article() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)(import_jsx_runtime_react_server.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsxs)("article", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
				...
				children: "Технический разбор"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h1", { children: "Как понять, нужна ли системе отопления промывка" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", {
				className: "intro",
				children: "Снижение теплоотдачи может быть связано с отложениями, но похожие признаки возникают и при неисправности автоматики, насоса или неправильной балансировке."
			}),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "На что обратить внимание" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Неравномерный нагрев, шум, длительный выход на рабочую температуру и загрязнённый теплоноситель — повод проверить систему. По одному признаку нельзя точно определить причину." }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Что происходит на осмотре" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Специалист оценивает оборудование, материал контура, точки подключения и характер загрязнений. После этого выбирает технологию, концентрацию раствора и продолжительность циркуляции." }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("h2", { children: "Ограничения" }),
			/* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("p", { children: "Промывка не устраняет механические повреждения и не заменяет ремонт неисправных узлов. После удаления плотных отложений может проявиться коррозионная негерметичность, существовавшая ранее." })
		]
	}), /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(site_shell_default, { page: "article" })] });
}
//#endregion
...
function robots() {
	return {
		...
		sitemap: "https://сети96.рф/sitemap.xml"
	};
}
//#endregion
...
var routes = [
	...
	},
	{
		...
		ids: {
			"route": "route:/api/leads",
			"page": null,
			"routeHandler": "route-handler:/api/leads",
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
			"slots": {}
	...
	},
	{
		...
		ids: {
			"route": "route:/organizaciyam",
			"page": "page:/organizaciyam",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
		...
		pattern: "/organizaciyam",
		patternParts: ["organizaciyam"],
		isDynamic: false,
		params: [],
		rootParamNames: [],
		page: page_exports$2,
	...
	},
	{
		...
		ids: {
			"route": "route:/materialy/:slug",
			"page": "page:/materialy/:slug",
			"routeHandler": null,
			"rootBoundary": "root-boundary:/",
			"layouts": ["layout:/"],
			"templates": [],
		...
		pattern: "/materialy/:slug",
		patternParts: ["materialy", ":slug"],
		isDynamic: true,
		params: ["slug"],
		rootParamNames: [],
		page: page_exports,
...
var __publicFiles = new Set([
	...
	"/file.svg",
	"/globe.svg",
	"/media/heat-exchangers-before-after.png",
	"/media/pipes-before-after.png",
	"/media/plate-heat-exchanger-before-after.png",
	"/media/radiator-circulation-diagram.png",
	"/media/radiator-thermal-before-after.png",
	"/media/seti96-logo.png",
	"/window.svg"
]);
...
var _virtual_vinext_rsc_entry_default = createAppRscHandler({
	...
	setNavigationContext: setAppNavigationContext,
	staticParamsMap: { "/materialy/:slug": null },
