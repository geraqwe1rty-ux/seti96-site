...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-BykUXe06.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"32ca04999434": async () => {
		const m = await import("./assets/admin-client-DI_b52o6.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-7zj15Qw1.js");
		return {
			get "ErrorBoundary"() {
	...
	"6f014b4f0add": async () => {
		const m = await import("./assets/site-shell-cOXW0E3T.js");
		return { get "default"() {
			return m["default"];
		} };
	},
